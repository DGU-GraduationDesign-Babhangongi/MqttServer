...
public class MemoController {
    ...
    @PostMapping("/add")
    public ResponseEntity<MemoDTO> addMemo(@RequestParam String building, @RequestParam String name, @RequestParam String content, HttpServletRequest request) {
    ...
    public ResponseEntity<Void> deleteMemo(@RequestParam Long memoId, HttpServletRequest request) {
        User user = joinService.getUserFromRequest(request);
    ...
    @GetMapping("/user")
    public ResponseEntity<List<MemoDTO>> getUserMemos(HttpServletRequest request) {
        User user = joinService.getUserFromRequest(request);
